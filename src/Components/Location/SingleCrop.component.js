...
const SingleCrop = ({ data }) => {
  ...
  return (
    <div
      className="rounded-xl h-[20vh] w-[20%] flex flex-col drop-shadow-xl shadow-md hover:scale-105 cursor-pointer hover:shadow-lg transition-all p-5"
      style={{
        background: `url(${food})`,
    ...
    >
      <div className="bg-white w-[90%] mx-auto h-[20vh] flex flex-col gap-y-2">
        <p className="text-3xl text-black font-black mt-5">{data.Crop}</p>
