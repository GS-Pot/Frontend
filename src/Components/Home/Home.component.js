    ...
    <div>
      ...
      <div className="flex items-center justify-between w-full h-[80vh] bg-wfptrn ">
        ...
        <div className="flex flex-col  gap-16  h-[80vh] ">
          ...
          <button className="bg-[#57AC49] text-white font-bold font-ss py-2 px-4 rounded-xl w-[16vw] h-[7vh] hover:bg-white hover:text-[#57AC49]">
            Try Now
          </button>
        </div>
      </div>
      <div
        className="flex items-center justify-between  w-full h-[80vh] bg-no-repeat rounded-[5vh] m-2"
